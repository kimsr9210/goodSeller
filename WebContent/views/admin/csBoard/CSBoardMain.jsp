			...
			<div class="row m-0">
				...
				<div class="col-10">
					<div class="row" style="height: 100%;">
						...
						<div class="QnABoardContents">

							<div class="row title p-0 m-0">
								<div id="title" class="col-12 text-center p-0 m-0">[관리자]Q&A게시판</div>
							</div>
							...
							String pageNavi = bpd.getCSpageNavi();
							%>
							...
							<div class="row p-0 m-0 line-content text-center">
								...
								<div class="col-12 col-md-6 p-0" id="allSubject">
