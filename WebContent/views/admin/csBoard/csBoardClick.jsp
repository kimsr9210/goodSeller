...
<body>
	...
	ArrayList<BoardAnswer> answer = (ArrayList<BoardAnswer>) request.getAttribute("answer");
					...
					<div class="row" style="height: 100%;">
						...
						<div class="reportBoardContents">
							...
							<div>
								...
								<table>
									<%
										for (BoardAnswer ba : answer) {
									%>
									<tr>
										<td id="content_<%=ba.getCommentNo()%>"><%=ba.getAdminId()%>&nbsp;&nbsp;<%=ba.getWriteDate()%>
											<br> <%=ba.getContent()%></td>
										<%
											}
										%>
								...
								%>
								<form action="/csBoardAnswer.do" method="post">
									<input type="text" size="30" name="comment"
										placeholder="댓글을 작성해보세요" /> <input type="hidden"
										name="boardNo" value="<%=board.getBoardNo()%>" /> <input
