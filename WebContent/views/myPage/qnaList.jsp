...
<!-- css -->
	<link rel="stylesheet" type="text/css" href="/resources/css/qnaList.css" />
     ...
     <div id="wrap"> <!-- 전체 틀-->
        ...
        <div id="contents" class="menu-none">
            ...
            <div id="contents-mypage">
                <div class="container">
                    <div id="qna-box" class="row col-12 col-lg-12">
                        <div id="info-title">
                            <div>Q&A</div>
                        </div>
                        <div id="qna-navi">
                        ...
                        <div class="qna-box-size">
                                <div>1</div>
                                <div><a href="#">계좌등록이 안돼요</a></div>
                                <div>20001</div>
                                <div>접수완료</div>
                        </div>
                        <div class="qna-box-size">
