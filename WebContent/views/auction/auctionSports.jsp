				...
				<div id="core-contents-2" class="row">
					...
					<div class="col-md-8">
						<ul class="nav nav-tabs">
							<li class="nav-item"><a class="nav-link active" href="#">골프</a>
							</li>
							<li class="nav-item"><a class="nav-link" href="#">스키/보드</a></li>
							<li class="nav-item"><a class="nav-link" href="#">수영/수상레저</a></li>
							<li class="nav-item"><a class="nav-link" href="#">구기/라켓</a></li>
							<li class="nav-item"><a class="nav-link" href="#">헬스/요가/필라테스</a></li>
