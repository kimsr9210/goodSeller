...
<body>
	...
	<%
		...
		String tradeEnd = (String) request.getAttribute("tradeEnd");
						...
						<div class="selleInformation">
							<div class="row">
								<div class="col-12">
									...
									<% if(tradeEnd.equals("N")){
										if (m.getUserId().equals(sellerId)) {
									%>
										<span  style="font-size:1.5em" class="infoFont">구매자의 거래 종료를 기다려 주세요.</span><br>
										<span class="infoFont">구매자가 거래 종료 버튼을 누르면 거래가 종료됩니다.</span><br>
									<%} else if(m.getUserId().equals(buyerId)) { %>
										<span  style="font-size:1.5em" class="infoFont">판매자의 거래 종료를 기다려 주세요.</span><br>
										<span class="infoFont">판매자가 거래 종료 버튼을 누르면 거래가 종료됩니다.</span><br>
									<%} else {%>
										<script>
											alert('잘못된 접근');
									...
									%>	<span  style="font-size:1.5em" class="infoFont">종료된 거래</span><br>
									<%} %>
									</div>
								</div>
							</div>
