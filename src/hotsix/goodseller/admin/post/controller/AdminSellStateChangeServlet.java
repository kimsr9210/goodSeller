...
/**
 * Servlet implementation class AdminSellStateChangeServlet
 */
@WebServlet("/adminSellStateChange.do")
public class AdminSellStateChangeServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AdminSellStateChangeServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (admin != null && 0 == admin.getUserNo() || (1 <= admin.getUserNo() && admin.getUserNo() <= 100)) {
			int result = new AdminPostService().updateSellStatePost(postNo, sell_yn);
