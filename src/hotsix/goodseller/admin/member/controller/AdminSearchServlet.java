	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			if(admin!=null && 0==admin.getUserNo()||(1<=admin.getUserNo()&&admin.getUserNo()<=100)) {
				...
				MemberPageData mpd = new AdminMemberService().adminSearchList(select, keyword, currentPage);
				if (mpd!=null) {
					RequestDispatcher view = request.getRequestDispatcher("/views/admin/member/adminSearchList.jsp");
