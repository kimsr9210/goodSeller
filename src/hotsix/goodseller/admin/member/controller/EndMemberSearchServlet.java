...
/**
 * Servlet implementation class EndMemberSearchServlet
 */
@WebServlet("/endMemberSearchList.do")
public class EndMemberSearchServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public EndMemberSearchServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			if(admin!=null && 0==admin.getUserNo()||(1<=admin.getUserNo()&&admin.getUserNo()<=100)) {
				...
				MemberPageData mpd = new AdminMemberService().endMemberSearchList(select, keyword, currentPage);
				if (mpd!=null) {
					RequestDispatcher view = request.getRequestDispatcher("/views/admin/member/endMemberSearchList.jsp");
