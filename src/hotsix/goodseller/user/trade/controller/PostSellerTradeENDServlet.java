...
/**
 * Servlet implementation class PostSellerTradeENDServlet
 */
@WebServlet("/tradeSellerEnd.do")
public class PostSellerTradeENDServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public PostSellerTradeENDServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int result = new TradeService().tradeSellerEnd(postNo, sellerId);
		...
		if(t.getBuyerState() == 'Y') {
			...
			if(tradeResult > 0) {
				...
				request.setAttribute("buyerEnd", t.getBuyerState());
				request.setAttribute("sellerEnd", t.getSellerState());
