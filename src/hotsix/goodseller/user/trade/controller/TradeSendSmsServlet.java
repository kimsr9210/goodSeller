...
/**
 * Servlet implementation class TradeSendSmsServlet
 */
@WebServlet("/sendSmsTrade.do")
public class TradeSendSmsServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public TradeSendSmsServlet() {
        super();
