...
/**
 * Servlet implementation class MyPageCsBoardClickNotAnsServlet
 */
@WebServlet("/myPageCsBoardClickNotAns.do")
public class MyPageCsBoardClickNotAnsServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public MyPageCsBoardClickNotAnsServlet() {
		super();
